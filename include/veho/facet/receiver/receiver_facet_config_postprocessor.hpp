        ...
        namespace receiver {
            namespace detail {
                ...
                struct determine_available_mailbox_count {
                    constexpr static const std::size_t value = veho::controller::controller_traits<
                ...
                struct determine_available_mailbox_count<Config, true> {
                    constexpr static const std::size_t total_mailbox_count = veho::controller::controller_traits<
